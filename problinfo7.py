...
aceste formule. 
"""
varsta_mariei = int(input("Dati varsta Mariei: "))
print("Greutatea ideala pentru Maria este: ",(2*varsta_mariei)+8)
print("Inaltimea ideala pentru Maria este: ",(5*varsta_mariei)+80)
